/**
 * The typed NoteFerry API client, derived from the shared `@noteferry/api` HttpApi
 ...
 *
 * @module noteferry/Domain/Runtime/NoteFerryApi
 *
 * @file      NoteFerryApi.ts
...
export/**
       * Submits feedback or a bug report for the current user. Emails NoteFerry —
