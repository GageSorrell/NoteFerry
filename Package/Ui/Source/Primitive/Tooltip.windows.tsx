/**
 * Windows variant of `Tooltip.tsx`. Identical except `TooltipDescription`'s
 * `"Image"` variant renders with React Native core's `Image` instead of
 * `expo-image`'s `Image`, which is not resolvable outside an Expo host.
 *
 * @module @noteferry/ui/Primitive/Tooltip
 *
 * @file      Tooltip.windows.tsx
